...
function finishHtml(res, html) {
	res.statusCode = 200;
	res.setHeader("content-type", "text/html; charset=utf-8");
	res.setHeader("cache-control", "no-store");
	res.end(html);
}
async function handleSkillBoardPage(req, res, expectedOrigin) {
	if (req.method !== "GET") {
		finishJson(res, 405, { error: "method not allowed" });
		return;
	}
...
//#endregion
export { handleSkillBoardList, handleSkillBoardPage, handleSkillBoardToggle, skillBoardRouteConstants };
